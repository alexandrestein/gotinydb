...
func init() {
	dumpCmd.Flags().StringVarP(&restoreSource, "source", "s", "./db-archive", "Defines the restore source")
	dumpCmd.Flags().BoolVar(&restoreJSON, "json", false, "import a JSON content instead of the encrypted stream.")
